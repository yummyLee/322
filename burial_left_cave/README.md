...
布局按参考图的主要空间关系做了低多边形近似：左上冷色阶梯水池与瀑布、中央高台尸骨区、右上木架/矿车工作区、左下钟乳石水潭、右下墓台、中央桥梁和后方黑暗通道。整体布局横纵向放大到 1.45 倍，各区域之间以窄路和高低错落的落脚平台连接，平台外保持黑色落差；补充了骨架陈列架、悬挂绳索、矿区箱具、斧镐、墓碑、桥栏、后洞祭台和洞壁苔藓。手绘裂纹、骨骼细节与水体体积光未按单张图逐像素复刻。
