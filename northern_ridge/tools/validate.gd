...
func run() -> void:
	...
	check(not portal.monitoring and portal.get_meta("target_scene")=="" and portal.get_meta("door_link_id")=="northern_root_cave_door","Future interior portal is reserved without an invalid scene jump")
